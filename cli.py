"""
Command Line Interface for Sepsis Bundle Timer.
"""
import argparse
import csv
import json
...
def main(argv=None):
    parser = argparse.ArgumentParser(prog="sepsis-bundle-timer", description="Sepsis Bundle Timer")
    ...
    if args.command == "chat":
        ...
        print(f"\n[Sepsis Bundle Timer Supervisor]:\n{ans}\n")
        return 0
    ...
    if args.command == "serve":
        ...
        print(f"Starting Sepsis Bundle Timer API server on http://{args.host}:{args.port}")
